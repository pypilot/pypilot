...
class Servo(object):
    ...
    def __init__(self, server, serialprobe):
        ...
        self.max_controller_temp = self.Register(RangeProperty, 'max_controller_temp', 65, 30, 100, persistent=True)
        self.max_motor_temp = self.Register(RangeProperty, 'max_motor_temp', 65, 30, 100, persistent=True)
