...
class Servo(object):
    ...
    def do_command(self, speed):
        ...
        if self.flags.value & (ServoFlags.FWD_FAULT | ServoFlags.MAX_RUDDER) and command > 0 or \
           self.flags.value & (ServoFlags.REV_FAULT | ServoFlags.MIN_RUDDER) and command < 0:
