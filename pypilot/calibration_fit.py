...
def FitPoints(points, current, norm):
    ...
    if plane_max_dev < 1.2:
        ...
        if ang > 15: # is 15 degrees too much?
            if debug:
    ...
    def f_new_sphere3(beta, x):
        ...
        return r0 + r1
    new_sphere3d_fit = FitLeastSq(initial[:4] + [1], f_new_sphere3, zpoints, 2)
