...
setup (name = 'pypilot',
       ...
       packages=['pypilot', 'pypilot_ui', 'pypilot_webapp', 'signalk'],
       package_data={'pypilot_ui': ['lcdclient_font.ttf'],
                     'pypilot_webapp': ['webapp/static/*', 'webapp/templates/*']},
#       requires=['flask', 'gevent'], # webapp
       entry_points={
           'console_scripts': [
               ...
               'pypilot_lcdclient=pypilot_ui.lcdclient:main',
