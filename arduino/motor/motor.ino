...
void process_packet()
{
    ...
    case MAX_SLEW_CCODE: {
        ...
        if(new_max_slew_speed > 250)
            new_max_slew_speed = 250;
        if(new_max_slew_slow > 250)
            new_max_slew_slow = 250;
...
//                out_sync_pos--; // remain at current measurement (avoid output overflow)
        ...
        case 26:
            ...
            break;
        case 29:
            v = min_rudder_pos | (max_rudder_pos >> 8);
            code = RUDDER_RANGE_RCODE;
            break;
        case 36:
            v = (max_slew_speed << 8) | max_slew_slow;
            code = MAX_SLEW_RCODE;
            break;
        case 39:
